---
title: 2021 年底前端工程師面試心得
date: '2022-01-11'
tags: ['career', 'interview', '職涯', '前端', 'frontend', '面試心得']
draft: false
summary: 用部落格記錄人生
authors: ['default']
---
...
- https://beta.reactjs.org/
  ...
  老手新手皆宜，React 新版的官網，全部的程式範例都是用 React Hook 去實作，看完基本上能掌握 React 大致的運作。

- https://www.patterns.dev/posts/

  整本書有三章，第一章介紹基本常用的 Design Pattern，第二章則是介紹 Rendering Pattern，也是我認為最精彩的部分，同時也是面試最常被問到的，尤其現在 Next 當道，那為何要用 Next，而又怎麼從 JQuery，Backbone 時代到 CSR 在到現在的 SSG/SSR 中間的利與弊都在這裡可以看到。最後一章則是介紹效能優化。
...
| 新公司     | 獵頭    | Offer get        | D+43 | Y    |
| Shopback   | 官網    | 一面後感謝信     | D+30 | N    |
| Line       | 官網    | 婉拒一面邀請     | D+41 | N    |

\*Y - 全英文, P - 部分英文, N - 中文

> 此次的面試時間是在 2021 年 11 ~ 12 月之間，會將分享著重在於準備方式以及學習，並只分享從中有學到東西的公司。
...
獵頭 LinkedIn 邀約(D) -> 獵頭 call (D+8) -> 1st with RD (D+18) -> 2nd-1 with Engineer Manager, 2nd-2 with Engineer Manager (D+24) -> 3rd with Hire Manager (D+39) -> offer call (D+43)
...
**第三面 - Team Hire Manager (US)**

流程: 介紹團隊 -> Q&A (1hr)

這關基本上就是未來所屬 Team 的 Hire Manager 聊天，交換彼此的想法，過程非常輕鬆愉快的，也更加確定這就是未來我想要進入的公司。
...
其實一開始面試都非常挫折，第一輪投的前四家都吃了感謝信或是無聲卡，當時覺得自己沒準備好就裸辭換工作是不明指的抉擇。但還是只能回頭檢討自己，把自己的心態調整好，很幸運的是第二輪就有拿到一些 offer，而且也是自己喜歡的公司！
